            ...
            <v-list-item three-line>
              <v-list-item-content>
                <div class="text-overline mb-4">
                  PHP {{ data.post_meta.salary }} //
                  {{ data.post_meta.classificationofwork }}
                </div>
                ...
                <v-list-item-title class="text-h8 mb-1 mt-4">
                  ...
                  {{ data.post_meta.purposeofvacancy }}
                </v-list-item-title>
                <v-list-item-title class="text-h8 mb-1">
                  <b>Classification of Vacancy:</b>
                  {{ data.post_meta.classificationofvacancy }}
                </v-list-item-title>
                ...
                <v-row>
                  <v-col cols="12" md="6" lg="6" sm="12">
                    <v-list-item-title class="text-h8 mb-1 mt-2">
                      ...
                      {{ data.post_meta.educationallevel }}
                    </v-list-item-title>
                    <v-list-item-title class="text-h8 mb-1">
                      <b>Course Requirement:</b>
                      {{ data.post_meta.courserequirements }}
                    </v-list-item-title>
                    <v-list-item-title class="text-h8 mb-1">
                    ...
                    <v-list-item-title class="text-h8 mb-1">
                      <b>Work Experience:</b>
                      {{ data.post_meta.workexperience }} months
                    </v-list-item-title>
                    <v-list-item-title class="text-h8 mb-1">
                      <b>Required License:</b>
                      {{ data.post_meta.requiredlicense }}
                    </v-list-item-title>
                    <v-list-item-title class="text-h8 mb-1">
                      <b>Other Qualifications:</b>
                      {{ data.post_meta.otherqualification }}
                    </v-list-item-title>
                    <v-list-item-title class="text-h8 mb-1">
                      <b>Employability Skills:</b>
                      {{ data.post_meta.employabilityskills }}
                    </v-list-item-title>
                  </v-col>
