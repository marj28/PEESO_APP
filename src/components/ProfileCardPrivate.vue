                                    ...
                                    <v-container>
                                        <v-row>
                                            <v-col cols="12" sm="12" md="8">
                                                <v-text-field label="Establishment Name" required outlined dense
                                            ...
                                            <v-col cols="12" sm="6" md="3">
                                                <v-text-field label="Tax Identification Number" required outlined dense
                                                    color="green"></v-text-field>
                                            </v-col>
                                            <v-col cols="12" sm="6" md="3">
                                                <v-select :items="etype" label="Employer Type" required small-chips outlined
                                                    dense color="green">
                                                </v-select>
                                            </v-col>
                                            <v-col cols="12" sm="6" md="3">
                                        ...
                                        <v-row>
                                            ...
                                            <v-col cols="12" sm="3" md="3">
                                                <v-text-field label="Telephone Number" required type="number" outlined dense
                                                    hide-spin-buttons color="green"></v-text-field>
                                            </v-col>
                                            <v-col cols="12" sm="3" md="3">
                                        ...
                                        <v-row>
                                            <v-col cols="12" sm="12" md="6">
                                                <v-file-input v-model="files" color="green accent-4" counter
                                                    ...
                                                    accept=".pdf, .docx" prepend-icon="mdi-paperclip" outlined
                                                    :show-size="1000" :rules="[rules.required]">
                                                </v-file-input>
                                            </v-col>
                                            <v-col cols="12" sm="12" md="6">
                                                <v-file-input v-model="files_permit" color="green accent-4" counter
                                                    ...
                                                    prepend-icon="mdi-paperclip" outlined accept=".pdf, .docx"
                                                    :show-size="1000" :rules="[rules.required]">
                                                </v-file-input>
                                            </v-col>
                                        </v-row>
              ...
              <v-card-text class="mt-6">
                ...
                discard it?
                        ...
                        <v-card-actions>
                            ...
                            <v-btn color="green darken-1" text @click="$router.push({ name: 'EmployerDashboard' })"
                                type="submit">
                                Save
                            </v-btn>
                        </v-card-actions>
