    ...
    <template v-slot:top>
      <v-card flat color="#FFFFFFF">
              ...
              <v-card-text>
                <v-container>
                  <v-row>
                    ...
                    <v-col cols="12" sm="6" md="6">
                      <v-text-field
                        v-model="editedItem.endoffiling"
                        label="End of Filing"
                        color="success"
                        outlined
                        dense
        ...
        <v-dialog v-model="dialogDelete" max-width="500px">
          <v-card>
            <v-card-title class=""
              >Are you sure you want to delete this Program?</v-card-title
            >
            <v-divider color="success"></v-divider>
            <v-card-actions>
              <v-spacer></v-spacer>
