                                    ...
                                    <v-stepper-content step="1">
                                        <v-card class="mb-12" height="100%">
                                            <v-row>
                                                ...
                                                <v-col cols="12" sm="6" md="6">
                                                    <v-select :items="totalworkforce" label="Total Work Force" outlined
                                                        dense color="green">
                                                    </v-select>
                                                </v-col>
                                                ...
                                                <v-col cols="12" md="3" sm="12">
                                                    <v-combobox label="Baranggay" :disabled="city == '' ? true : false"
                                                        outlined dense color="success" :items="brgyname"
                                                        :rules="[rules.required]"></v-combobox>
                                                </v-col>
                                                <v-col cols="12" md="12" sm="12">
                                                    <v-text-field label="House No. / Street / Village" required outlined
                                                    ...
                                                    <v-container fluid>
                                                        <v-row>
                                                            <v-col cols="12" sm="2" md="2">
                                                                <v-select :items="title" label="Title" outlined dense
                                                                    multiple small-chips color="green"
                                                                    :rules="[rules.required]">
                                                                </v-select>
                                                            </v-col>
                                                            <v-col cols="12" sm="10" md="10">
                                                                <v-text-field label="Contact Person (Full Name)" required
                                                                    outlined dense :rules="[rules.required]"
                                                                    color="green"></v-text-field>
                                                            </v-col>
                                                            <v-col cols="12" sm="3" md="3">
                                                                <v-text-field label="Position" required outlined dense
                                                                    color="green" :rules="[rules.required]"></v-text-field>
                                                            </v-col>
                                                            <v-col cols="12" sm="3" md="3">
                                                                <v-text-field label="Telephone Number" required
                                                                    type="number" outlined dense :rules="[rules.required]"
                                                                    color="green" hide-spin-buttons></v-text-field>
                                                            </v-col>
                                                            <v-col cols="12" sm="3" md="3">
                                                                <v-text-field label="Mobile Number" required outlined dense
                                                                    type="number" :rules="[rules.required]" color="green"
                                                                    hide-spin-buttons></v-text-field>
                                                            </v-col>
                                                            <v-col cols="12" sm="3" md="3">
                                                                <v-text-field label="E-mail Address" required outlined dense
                                                    ...
                                                    <v-row>
                                                        <v-col cols="12" sm="12" md="6">
                                                            <v-file-input v-model="files" color="green accent-4" counter
                                                                ...
                                                                outlined :show-size="1000" :rules=rules>
                                                            </v-file-input>
                                                        </v-col>
                                                        <v-col cols="12" sm="12" md="6">
