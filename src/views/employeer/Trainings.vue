        ...
        <v-card color="tertiary" dark>
          <v-card-text class="text-center" @click="popupform = true, state = 'new', post = {}" style="height: 100px;">
            <div style="margin-top: 20px;"><v-icon large left>mdi-plus-circle</v-icon> <span
                style="font-size: 20px;color: black;">POST TRAINING</span></div>
          </v-card-text>
        </v-card>
      </v-col>
        ...
        <v-card flat color="#FFFFFF">
          <v-card-title class="white--black">TRAINING OFFERING
            ...
            <v-text-field v-model="search" append-icon="mdi-magnify" label="Search" single-line hide-details outlined
              rounded dense dark></v-text-field>
                  ...
                  <v-container>
                    <v-row>
                      <v-col cols="12" sm="12" md="12">
                        <v-text-field v-model="editedItem.training_title" label="Training Title" color="success" outlined
                          dense></v-text-field>
                      </v-col>
                      <v-col cols="12" sm="6" md="6">
                        <v-text-field v-model="editedItem.nature_training" label="Nature of Training" color="success"
                          outlined dense class="mt-n8"></v-text-field>
                      </v-col>
                      <v-col cols="12" sm="6" md="6">
                        <v-text-field v-model="editedItem.place_training" label="Place of Training" color="success"
                          outlined dense class="mt-n8"></v-text-field>
                      </v-col>
                      <v-col cols="12" sm="6" md="6">
                        <v-text-field v-model="editedItem.date_training" label="Date" color="success" outlined dense
                          class="mt-n8" type="date"></v-text-field>
                      </v-col>
                      <v-col cols="12" sm="6" md="6">
                        <v-text-field v-model="editedItem.time_training" label="Time" color="success" outlined dense
                          class="mt-n8" type="time"></v-text-field>
                      </v-col>
                      <v-col cols="12" sm="6" md="12">
                        <v-text-field v-model="editedItem.participant_count" label="Participant Count" color="success"
                          outlined dense class="mt-n8" type="number"></v-text-field>
                      </v-col>
                      <v-col cols="12" sm="6" md="12">
                        <v-textarea v-model="editedItem.training_description" label="Training Description" color="success"
