        ...
        <v-container>
          <v-row>
            <v-col cols="12" sm="12" md="12">
              <v-text-field label="Training Title" color="success" outlined dense></v-text-field>
            </v-col>
            <v-col cols="12" sm="6" md="6">
              <v-text-field label="Nature of Training" color="success" outlined dense class="mt-n8"></v-text-field>
            </v-col>
            <v-col cols="12" sm="6" md="6">
              <v-text-field label="Place of Training" color="success" outlined dense class="mt-n8"></v-text-field>
            </v-col>
            <v-col cols="12" sm="6" md="6">
              <v-text-field label="Date" color="success" outlined dense class="mt-n8" type="date"></v-text-field>
            </v-col>
            <v-col cols="12" sm="6" md="6">
              <v-text-field label="Time" color="success" outlined dense class="mt-n8" type="time"></v-text-field>
            </v-col>
            <v-col cols="12" sm="6" md="12">
              <v-text-field label="Participant Count" color="success" outlined dense class="mt-n8"
