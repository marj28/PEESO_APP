  ...
  >
    <template v-slot:top>
      <v-card flat color="#FFFFFF">
        <v-card-title class="white--black"
          >TRAINING OFFERING
          <v-spacer></v-spacer>
          <v-spacer></v-spacer>
          <v-spacer></v-spacer>
          ...
          <v-card>
            ...
            <v-card-text>
              <v-container>
                <v-row>
                  <v-col cols="12" sm="12" md="12">
                    <b class="green--text">Training Title:</b>
                    {{ editedItem.training_title }}
                  </v-col>
                  <v-col cols="12" sm="12" md="12">
                    <b class="green--text">Nature of Training:</b>
                    {{ editedItem.nature_training }}
                  </v-col>
                  <v-col cols="12" sm="12" md="12">
                    <b class="green--text">Place of Training:</b>
                    {{ editedItem.place_training }}
                  </v-col>
                  <v-col cols="12" sm="12" md="12">
                    <b class="green--text">Date of Training:</b>
                    {{ editedItem.date_training }}
                  </v-col>
                  <v-col cols="12" sm="12" md="12">
                    <b class="green--text">Time of Training:</b>
                    {{ editedItem.time_training }}
                  </v-col>
                  <v-col cols="12" sm="12" md="12">
                    <b class="green--text">Participant Count:</b>
                    {{ editedItem.participant_count }}
                  </v-col>
                  <v-col cols="12" sm="12" md="12" class="mb-n6">
                    <b class="green--text">Training Description:</b>
                    {{ editedItem.training_description }}
                  </v-col>
                </v-row>
              </v-container>
            </v-card-text>
...
export default {
  data: () => ({
    ...
    headers: [
      ...
      {
        text: "NATURE OF TRAINING",
        value: "nature_training",
        sortable: false,
      },
      {
        text: "PLACE OF TRAINING",
        value: "place_training",
        sortable: false,
      },
