                                      ...
                                      <v-card class="mb-12" height="100%">
                                          <v-row>
                                              ...
                                              <v-col cols="12" sm="12" md="4">
                                                  <v-text-field v-model="company.acronym" label="Acronym / Abbreviation"
                                                      required outlined dense :rules="[rules.required]"
                                                      color="green"></v-text-field>
                                              </v-col>
                                              <v-col cols="12" sm="6" md="3">
                                                  <v-text-field v-model="company.tax_identification_number"
                                                      label="Tax Identification Number" required outlined dense
                                                      color="green"></v-text-field>
                                              </v-col>
                                              <v-col cols="12" sm="6" md="3">
                                                  <v-select v-model="company.employer_type" :items="etype"
                                                      label="Employer Type" required small-chips outlined dense
                                                      color="green">
                                                  </v-select>
                                              </v-col>
                                              <v-col cols="12" sm="6" md="3">
                                                  <v-select v-model="company.total_work_force" :items="totalworkforce"
                                                      label="Total Work Force" outlined dense color="green">
                                                  </v-select>
                                              </v-col>
                                              <v-col cols="12" sm="6" md="3">
                                                  <v-select v-model="company.industry" :items="industry" label="Industry"
                                                      outlined dense color="green">
                                                  </v-select>
                                              </v-col>
                                              <v-col cols="12" md="3" sm="12">
                                                  <v-combobox v-model="company.region_name" :items="address"
                                                      item-text="region_name" outlined dense color="success"
                                                      label="Region" @change="formattype('REGION')" return-object
                                                      single-line :rules="[rules.required]">
                                                  </v-combobox>

                                              </v-col>
                                              <v-col cols="12" md="3" sm="12">
                                                  <v-combobox v-model="company.provincename" :items="provincename"
                                                      :disabled="region == '' ? true : false" outlined dense
                                                      color="success" label="Province" @change="formattype('PROVINCE')"
                                                      return-object single-line :rules="[rules.required]">

                                                  </v-combobox>
                                              </v-col>
                                              <v-col cols="12" md="3" sm="12">
                                                  <v-combobox v-model="company.city_name" :items="cityname"
                                                      :disabled="province == '' ? true : false" outlined dense
                                                      label="Municipality / City" @change="formattype('CITY')"
                                                      return-object color="success" :rules="[rules.required]" single-line>
                                              ...
                                              <v-col cols="12" md="12" sm="12">
                                                  <v-text-field v-model="company.house"
                                                      label="House No. / Street / Village" required outlined dense
                                                      color="success" :rules="[rules.required]"></v-text-field>
                                              </v-col>
                                          </v-row>
                                      </v-card>
                                                  ...
                                                  <v-container fluid>
                                                      <v-row>
                                                          <v-col cols="12" sm="2" md="2">
                                                              <v-select v-model="company.title" :items="title" label="Title"
                                                                  outlined dense multiple small-chips
                                                                  :rules="[rules.required]" color="green">
                                                              </v-select>
                                                          </v-col>
                                                          <v-col cols="12" sm="10" md="10">
                                                              <v-text-field v-model="company.contact_person"
                                                                  label="Contact Person (Full Name)" required outlined
                                                                  dense :rules="[rules.required]"
                                                                  color="green"></v-text-field>
                                                          </v-col>
                                                          <v-col cols="12" sm="3" md="3">
                                                              <v-text-field v-model="company.position" label="Position" required
                                                                  outlined dense color="green"></v-text-field>
                                                          </v-col>
                                                          <v-col cols="12" sm="3" md="3">
                                                              <v-text-field v-model="company.telephone_number" label="Telephone Number"
                                                                  required type="number" outlined dense hide-spin-buttons
                                                                  color="green"></v-text-field>
                                                          </v-col>
                                                          <v-col cols="12" sm="3" md="3">
                                                              <v-text-field v-model="company.mobile_number" label="Mobile Number"
                                                                  required outlined dense type="number"
                                                                  :rules="[rules.required]" hide-spin-buttons
                                                                  color="green"></v-text-field>
                                                          </v-col>
                                                          <v-col cols="12" sm="3" md="3">
                                                              <v-text-field v-model="company.email_address" label="E-mail Address"
                                                                  required outlined dense type="email"
                                                                  :rules="[rules.required]" color="green"></v-text-field>
                                                          </v-col>
                                                      </v-row>
                                                  </v-container>
                                                  ...
                                                  <v-row>
                                                      <v-col cols="12" sm="12" md="6">
                                                          <v-file-input v-model="files" color="green accent-4" counter
                                                              label="Business License" multiple dense
                                                              placeholder="Select your files" accept=".pdf, .docx"
                                                              prepend-icon="mdi-paperclip" outlined :show-size="1000"
                                                              :rules="[rules.required]">
                                                          </v-file-input>
                                                      </v-col>
                                                      <v-col cols="12" sm="12" md="6">
                                                          <v-file-input v-model="files_permit" color="green accent-4"
                                                              counter label="Business Permit" multiple dense
                                                              placeholder="Select your files" prepend-icon="mdi-paperclip"
                                                              outlined accept=".pdf, .docx" :show-size="1000"
                                                              :rules="[rules.required]">
                                                          </v-file-input>
                                                      </v-col>
                                                  </v-row>
