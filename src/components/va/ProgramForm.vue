  ...
  <v-dialog v-model="dailog" persistent max-width="500px">
    <v-card>
          ...
          <v-container>
            <v-row>
              <v-col cols="12" sm="12" md="12">
                <v-text-field
                  v-model="post.post_meta.ProgramName"
                  label="Program Name"
                  color="success"
                  outlined
                  required
              ...
              <v-col cols="12" sm="12" md="12">
                <v-text-field
                  v-model="post.post_meta.OfferingCompany"
              ...
              <v-col cols="12" sm="6" md="6">
                <v-text-field
                  v-model="post.post_meta.EndofFilling"
                  label="End of Filing"
                  color="success"
                  outlined
                  dense
              ...
              <v-col cols="12" sm="12" md="12">
                <v-text-field
                  v-model="post.post_meta.ApplicantCount"
              ...
              <v-col cols="12" sm="12" md="12">
                <v-textarea
                  v-model="post.post_meta.ProgramDescription"
      ...
      <v-card-actions>
        ...
        <v-btn color="green darken-1" dark @click="SavePost()"> Save </v-btn>
      </v-card-actions>
    </v-card>
  </v-dialog>
</template>
      ...
      this.$http
        ...
        .then((response) => {
          ...
          if (response.data.status) {
            ...
            this.post.post_meta.ProgramDescription =
              this.company.ProgramDescription;
              console.log("test");
          }
        })
        .catch((e) => {
