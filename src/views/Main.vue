              ...
              <template v-for="(item, index) in jobs">
                ...
                >
                  ...
                  <v-list-item-content>
                    ...
                    <v-list-item-subtitle> <em class="text-info">{{$moment(item.created_dt).startOf('day').fromNow()}}</em> - {{item.post_meta.company}} - {{item.post_meta.company_address}} </v-list-item-subtitle>
                  </v-list-item-content>
                </v-list-item>
              </template>
            </v-list>
...
import {
  ...
  export default {
    ...
    methods: {
      ...
      jobposts() {
          this.$http.post('post/list', {type:'job'}).then(response => {  
