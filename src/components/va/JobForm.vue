   ...
   label="Job Title"/>
        ...
        <v-select
                     v-model="post.post_meta.purposeofvacancy"
                      ...
                      prepend-inner-icon="mdi-office-building-marker-outline"
                      dense 
                      :items="['Additional Manpower', 'Replacement', 'Expansion']" 
                      :rules="nameRules"
                      required
  ...
  <h3 class="text-center">Preferrence</h3>
                      ...
                      <v-row class="mt-5">
                        ...
                        <v-col class="ml-0 mt-n7 ml-lg-7 mt-lg-n7 ml-md-7 mt-md-n7 ml-sm-7 mt-sm-n7" cols="12" sm="11" md="11" >
                            ...
                            label="If 'yes': " multiple dense color="green" outlined 
                              >
                            </v-select>
                          </v-col>
  ...
  <v-card-text>
                      <v-row>
                        ...
                        <v-col cols="12" sm="12" md="12" class="mt-n7 ml-3">
                          ...
                          label="Required License: "  required outlined
                            dense color="green"></v-text-field>
                        </v-col>
                        <v-col cols="12" sm="12" md="12" class="mt-n7 ml-3">
                          <v-text-field
                          v-model="post.post_meta.otherqualification"
                           label="Other qualifications: "  required
                        ...
                        <v-col cols="12" sm="12" md="12" class="mt-n7 ml-3">
                          ...
                          label="Employability Skills" outlined multiple
                        ...
                        <v-col cols="12" sm="12" md="12" class="mt-n7 ml-4" >
                          ...
                          v-model="post.post_meta.acceptsreturningofws"
                           label="Accepts returning OFWs: " row>
                            <v-radio label="Yes" value="yes" color="green">
                            </v-radio>
                            <v-radio label="No" value="no" color="green">
                            </v-radio>
