            ...
            <v-card class="my-5 mt-3" color="#1B5E20">
              <v-row>
                ...
                <v-col
                  ...
                  lg="4"
                  sm="4"
                  class="mt-n6 mt-lg-n2 mt-md-n2 mt-sm-n2"
                >
                  <!-- <v-toolbar flat dark color="#1B5E20">
                    <div
                      class="text-center mt-10"
...
export default {
  ...
  methods: {
    showHeader(header) {
      return !this.isMobile || header.value !== "post_meta.salary";
    },
