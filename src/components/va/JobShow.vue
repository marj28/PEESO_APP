...
<template>
 ...
 -->
               ...
               <!--    <v-tiptap readonly v-model="post.content"/> -->
                ...
                <v-list-item-title class="text-h8 mb-1">
                  <b>Classification of Vacancy:</b>
                  {{ post.post_meta.classificationofvacancy }}
                </v-list-item-title>
                <v-list-item-title class="text-h8 mb-2">
                  <b>Place of Work:</b> {{ post.post_meta.placeofwork }}
                </v-list-item-title>
                <v-divider></v-divider>
                <h3 class="mt-2 green--text">PREFERENCES:</h3>
                <v-row> -->
                  <v-col cols="12" md="6" lg="6" sm="12">
                    <v-list-item-title class="text-h8 mb-1 mt-2">
                      ...
                      {{ post.post_meta.educationallevel }}
                    </v-list-item-title>
                    <v-list-item-title class="text-h8 mb-1">
                      <b>Course Requirement:</b>
                      {{ post.post_meta.courserequirements }}
                    </v-list-item-title>
                    <v-list-item-title class="text-h8 mb-1">
                      <b>Sex Preference:</b> {{ post.post_meta.sexpreference }}
                    </v-list-item-title>
                    <v-list-item-title class="text-h8 mb-1">
                      <b>Work Experience:</b>
                      {{ post.post_meta.workexperience }} months
                    </v-list-item-title>
                    <v-list-item-title class="text-h8 mb-1">
                      <b>Required License:</b>
                      {{ post.post_meta.requiredlicense }}
                    </v-list-item-title>
                    <v-list-item-title class="text-h8 mb-1">
                      <b>Other Qualifications:</b>
                      {{ post.post_meta.otherqualification }}
                    </v-list-item-title>
                    <v-list-item-title class="text-h8 mb-1">
                      <b>Employability Skills:</b>
                      {{ post.post_meta.employabilityskills }}
                    </v-list-item-title>
                  </v-col>
                  <v-col cols="12" md="6" lg="6">
                    <v-list-item-title class="text-h8 mb-1">
                      <b>Posting Date:</b> {{ post.post_meta.postingdate }}
                    </v-list-item-title>
                    <v-list-item-title class="text-h8 mb-1">
                      <b>Valid Until:</b> {{ post.post_meta.validuntil }}
                    </v-list-item-title>
                  </v-col>
                </v-row>
