    ...
    <v-col cols="12" md="12">
      ...
      <v-card>
        <v-toolbar elevation="0">
          ...
          <v-spacer />
          <template v-if="can_apply"> </template>
        ...
        <v-card-text style="min-height: 130px">
          ...
          <div class="text-info">
            <em
              >POSTED ON
              {{ $moment(post.created_td).format("MMM DD, YYYY") }}</em
            >
          </div>
          <v-btn color="primary" dark @click="dialogschedule = true">
            Add Schedule
          </v-btn>
          <v-dialog v-model="dialogschedule" max-width="50%">
            <v-card>
              <v-card-title>
              ...
              <v-card-text>
                <v-container>
                  <v-row>
                    ...
                    <v-col cols="12" md="3" class="mb-n6">
                      <v-menu
                      ...
                      >
                        ...
                        <v-time-picker
                          ...
                          @click:second="$refs.timePicker.save(selectedTime)"
                        ></v-time-picker>
                      </v-menu>
                    </v-col>
                    <v-col cols="12" md="3" class="mb-n6">
                      <v-menu
                        ...
                        v-model="timePicker1"
                        :close-on-content-click="false"
                        :return-value.sync="selectedTime1"
                        transition="scale-transition"
                        offset-y
                        max-width="290px"
                        min-width="290px"
                      >
                        ...
                        <v-time-picker
                          ...
                          @click:second="$refs.timePicker.save(selectedTime1)"
                        ></v-time-picker>
                      </v-menu>
                    </v-col>
                    <v-col cols="12" md="6" class="mb-n6">
    ...
    <v-card style="padding: 2%">
      ...
      >
        <template v-slot:[`item.actions`]>
          <v-btn small color="primary" @click="$router.push('/table-passing')">
...
export default {
  ...
  methods: {
    ...
    getpost(id) {
      this.$http
        .post("post/get", { id: this.$IsNum(id) })
        .then((response) => {
